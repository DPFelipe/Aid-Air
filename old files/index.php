...
//login_success.php  
 ...
 {  
      ...
      echo '<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logoutuser.php">Logout</a>'; 
 }  
 else  
 {  
...
<div class="container">
  <form action="add.php" method="post">
    ...
    <div class="row">
    <br>
      <button onclick ="myFunction()" type="submit" name = "insert" style="float: right "; class="w3-button w3-padding-large w3-red w3-margin-bottom w3-round"  >Submit</button>
    </div>
  </form>
</div> 
</div>
