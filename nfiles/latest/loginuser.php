...
<body>
    ...
    <br>
      <h1 class="w3-text-red">The</h1>
      <h1 class="w3-jumbo w3-text-red w3-hide-small"><b>Aid-Air +</b></h1>
...
<div id="id02" class="modal1" >
  ...
  <form class="modal-content1 w3-animate-zoom" method="post" action="signupadd.php">
    <div class="imgcontainer">
