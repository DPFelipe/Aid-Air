...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:20%;font-weight:bold;" id="mySidebar"><br>
  ...
  <div id="demoAcc" class="w3-hide w3-white w3-card">
    <a href="../Crud/sampleedit.php" onclick="document.getElementById('id01').style.display='block'" class="w3-bar-item w3-button w3-hover-white" >Admin Accounts</a>
...
<div class="w3-main" style="margin-left:312.5px;margin-right:40px;">
 ...
 <header class="w3-container w3-center w3-padding-48 w3-white" id="home">
    ...
    <h6>Logged in as - Admin <span class="w3-tag w3-red"><?php echo $_SESSION["ID"] ?></span></h6>
  </header> 

 <!--image header-->
  <header  class="w3-display-container w3-wide" id="home">
    <img class="w3-image" src="../pictures/img.jpg" alt="connection error" width="1600" height="1060">
 ...
 <input type = "text" name = "search" style = 'width:30%'><button type = "submit"  name = "Find" class="w3-button w3-padding-large w3-red w3-margin-bottom w3-round" style = "margin-top: 13px;margin-left: 10px;">Find</button></form>
 </div>
 <!-- !Reports! -->
 <?php
    ...
    while($row=$pdoResult->fetch(PDO::FETCH_ASSOC)) {
        ...
        if($Severity=="Critical"){
          echo "<th style = 'color:white;background-color:red;'>$Severity</th>";
        }
        elseif($Severity=="Needs action"){
          echo "<th style = 'color:white;background-color:orange;'>$Severity</th>";
        }
        elseif($Severity=="Mild"){
          echo "<th style = 'color:white;background-color:green;'>$Severity</th>";
        }
        echo "<td>$Report</td>";
